...
public:
    ...
    void setUpPointLight(Shader& lightingShader)
    {
        ...
        {
            lightingShader.setVec3("directionalLights[0].position", position);
            lightingShader.setVec3("directionalLights[0].ambient", ambientOn * ambient);
            lightingShader.setVec3("directionalLights[0].diffuse", diffuseOn * diffuse);
            lightingShader.setVec3("directionalLights[0].specular", specularOn * specular);
            lightingShader.setFloat("directionalLights[0].k_c", k_c);
            lightingShader.setFloat("directionalLights[0].k_l", k_l);
            lightingShader.setFloat("directionalLights[0].k_q", k_q);
        }
        /*else
        {
